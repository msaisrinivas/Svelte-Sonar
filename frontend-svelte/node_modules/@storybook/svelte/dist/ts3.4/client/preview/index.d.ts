...
}) => void) | (() => never), clearDecorators: (() => void) | (() => never), getStorybook: (() => never) | (() => import("@storybook/client-api/dist/ts3.9/ClientApi").GetStorybookKind<import("./types").SvelteFramework>[]), raw: (() => never) | (() => import("@storybook/store").BoundStory<import("./types").SvelteFramework>[]);
export declare const storiesOf: (kind: string, m: any) => import("@storybook/addons").StoryApi<any>;
